...
EOL
    # ===== FIX nginx agar auto-restart jika gagal =====
...
memasang_pencadangan() {
  ...
  cat > /root/.config/rclone/service-account.json << 'EOF'
{
  "type": "service_account",
  "project_id": "rclone-backup-475317",
  "private_key_id": "0e9d9aebec691b7563b89bb07b8c03369aa25015",
  "private_key": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
  "client_email": "rclone-backup@rclone-backup-475317.iam.gserviceaccount.com",
  "client_id": "102037528244088429651",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/rclone-backup%40rclone-backup-475317.iam.gserviceaccount.com",
...
function memasang_limit_global_systemd() {
    clear
    print_install "Mengatur Limit Global Systemd (500K file/socket & proses)"

    # Tambahkan limit global systemd
    for f in /etc/systemd/system.conf /etc/systemd/user.conf; do
        sed -i '/DefaultLimitNOFILE/d' $f
        sed -i '/DefaultLimitNPROC/d' $f
        echo "DefaultLimitNOFILE=500000" >> $f
        echo "DefaultLimitNPROC=500000" >> $f
    done

    systemctl daemon-reexec
    systemctl daemon-reload
    print_success "Limit Global Systemd Aktif (500K)"
}
function memasang_xray_limits() {
    clear
    print_install "Mengatur Limit Service Xray & Nginx (500K)"
    ...
    # Sinkronkan limit untuk xray & nginx
    for svc in nginx xray; do
        if [ -f /etc/systemd/system/${svc}.service ]; then
            sed -i '/LimitNOFILE/d' /etc/systemd/system/${svc}.service
            sed -i '/LimitNPROC/d' /etc/systemd/system/${svc}.service
            sed -i '/^\[Service\]/a LimitNOFILE=500000\nLimitNPROC=500000' /etc/systemd/system/${svc}.service
        fi
    done
    ...
    print_success "Limit Xray & Nginx Disinkronisasi (500K)"
}
...
for svc in netfilter-persistent fail2ban xray dropbear ws-stunnel noobzvpns haproxy server-sldns; do
...
END
    ...
    # =================== SETUO REBOOT DEFAULT ===================
# Buat folder aman untuk log (tidak ikut dibersihkan cron)
mkdir -p /etc/logs

# Buat atau perbarui cron auto reboot
cat > /etc/cron.d/daily_reboot <<'EOF'
SHELL=/bin/bash
PATH=/usr/local/sbin:/usr/local/bin:/sbin:/bin:/usr/sbin:/usr/bin
0 4 * * * root bash -c 'systemctl stop nginx haproxy xray; sleep 10; sync; sleep 10; /sbin/reboot'
EOF

# Pastikan log-nya aman dan bisa ditulis oleh cron
touch /etc/logs/auto-reboot.log
chmod 644 /etc/logs/auto-reboot.log
chown root:root /etc/logs/auto-reboot.log

# Restart cron agar jadwal baru langsung aktif
...
After=network-online.target nss-lookup.target netfilter-persistent.service rc-local.service
...
User=root
Type=simple
ExecStartPre=/bin/bash -c 'sleep 30; until ping -c1 8.8.8.8 &>/dev/null; do sleep 5; done; sleep 10'
...
EOF
    ...
    systemctl enable --now udp-custom
        ...
        # ===================== UDP KEEPALIVE =====================
    cat > /usr/local/sbin/udp-keepalive.sh <<'EOF'
#!/bin/bash
while true; do
  echo "ping" | nc -u -w1 127.0.0.1 7400 >/dev/null 2>&1
  sleep 30
done
EOF

    chmod +x /usr/local/sbin/udp-keepalive.sh

    cat > /etc/systemd/system/udp-keepalive.service <<'EOF'
[Unit]
Description=UDP KeepAlive for UDP Custom 7400
After=network-online.target udp-custom.service
Wants=network-online.target
Requires=udp-custom.service

[Service]
Type=simple
ExecStart=/usr/local/sbin/udp-keepalive.sh
Restart=always
RestartSec=3
...
EOF
    ...
    systemctl daemon-reload
    systemctl enable --now udp-keepalive
    # =================== END KEEPALIVE ======================
